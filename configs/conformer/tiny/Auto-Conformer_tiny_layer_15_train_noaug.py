...
work_dir = './Auto-Conformer_tiny_layer_15_train_noaug'
repeated_aug=True
        ...
        dict(
            ...
            anchors=[
                dict({
                    ...
                    'arch.backbone.body.block.embed_dim.width': 240,
                    'arch.backbone.body.block.transblock.MHA.num_heads.num_heads': [4,4,4],
                ...
                dict({
                    ...
                    'arch.backbone.body.block.embed_dim.width': 192,
                    'arch.backbone.body.block.transblock.MHA.num_heads.num_heads': [2,2,2],
                ...
                dict({
                    ...
                    'arch.backbone.body.block.embed_dim.width': 192,
                    'arch.backbone.body.block.transblock.MHA.num_heads.num_heads': [3,3,3],
                    'arch.backbone.body.block.transblock.FFN.feedforward_channels.feedforward_channels': [40,40,40]
                })
            ]),
        dict(
