...
work_dir = './Auto-Conformer_base_layer_15_train_aug'
repeated_aug=True
...
model = dict(
    ...
    neck=None,
    head=dict(
        type='ElasticConformerPoolingHead',
        num_classes=1000,
        in_channels=448,#
        channel_ratio=1280,#
        ...
        dict(
            ...
            anchors=[
                dict({
                    ...
                    'arch.backbone.body.block.convblock.width': [320,640,1280],
                    'arch.backbone.body.block.embed_dim.width': 448,
                    'arch.backbone.body.block.transblock.MHA.num_heads.num_heads': [7,7,7],
                ...
                dict({
                    ...
                    'arch.backbone.body.block.convblock.width': [192,384,768],
                    'arch.backbone.body.block.embed_dim.width': 320,
                    'arch.backbone.body.block.transblock.MHA.num_heads.num_heads': [5,5,5],
                ...
                dict({
                    ...
                    'arch.backbone.body.depth': [4,4,3],
                    'arch.backbone.body.block.convblock.width': [256,512,1024],
                    'arch.backbone.body.block.embed_dim.width': 384,
                    'arch.backbone.body.block.transblock.MHA.num_heads.num_heads': [6,6,6],
                    'arch.backbone.body.block.transblock.FFN.feedforward_channels.feedforward_channels': [40,40,40]
                })
            ]),
        dict(
