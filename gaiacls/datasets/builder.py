...
from .samplers import DistributedSampler, RASampler
...
def build_dataloader(dataset,
    ...
    if dist:
        if repeated_aug:
            print("-------------------------repeated_aug used!-------------------------")
            sampler = RASampler(dataset, world_size, rank, shuffle=shuffle)
        else:
            sampler = DistributedSampler(dataset, world_size, rank, shuffle=shuffle, round_up=round_up)
