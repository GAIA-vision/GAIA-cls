...
class ElasticConformerPoolingHead(ClsHead, DynamicMixin):
    def __init__(self,
                 num_classes,
                 in_channels,
                 channel_ratio,
                 ...
                 *args,
                 **kwargs):
        super(ElasticConformerPoolingHead, self).__init__(*args, **kwargs)
    ...
    def forward_train(self, x, x_t, gt_label, **kwargs):
        ...
        x_t = torch.mean(x_t[:, 1:] , dim=1)
        tran_cls = self.trans_cls_head(x_t) # bs 1000
